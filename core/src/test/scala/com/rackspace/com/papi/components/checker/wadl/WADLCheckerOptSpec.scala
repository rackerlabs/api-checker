...
class WADLCheckerOptSpec extends BaseCheckerSpec {
  ...
  feature ("The WADLCheckerBuilder can correctly transforma a WADL into checker format") {
    ...
    scenario ("The sharedXPathWADL is processed checking wellformness, XSD, elemnts, and plain parameters, with remove dups and joinpath optimizations") {
      ...
      assert (checker, "count(/chk:checker/chk:step[@type='XPATH' and @match='/atom:entry/w_ns18:usage']) = 1")
      assert (checker, "count(/chk:checker/chk:step[@type='XPATH' and @match='/atom:entry/@only_usage']) = 1")
      assert (checker, "count(/chk:checker/chk:step[@type='XSL' and @version='1']) = 2")
      assert (checker, "count(/chk:checker/chk:step[@type='XSL']//xsl:when[@test='/atom:entry']) = 2")
    }


    scenario ("The sharedXPathWADL is processed checking wellformness, XSD, elemnts, and plain parameters, with remove dups and joinpath optimizations (XPath 2.0)") {
      Given("the sharedXPathWADL")
      When("The WADL is transalted")
      val checker = builder.build(sharedXPathWADL, TestConfig(true, false, true, true, true, 20, true, true, false, "SaxonHE", true))
      Then ("The following paths should hold")
    ...
    scenario ("The sharedXPathWADL is processed checking wellformness, XSD, elemnts, and plain parameters, with remove dups and joinpath optimizations (XPath 3.0)") {
      Given("the sharedXPathWADL")
      When("The WADL is transalted")
      val checker = builder.build(sharedXPathWADL, TestConfig(true, false, true, true, true, 30, true, true, false, "SaxonHE", true))
      Then ("The following paths should hold")
    ...
    scenario ("The sharedXPathWADL is processed checking wellformness, XSD, elemnts, and plain parameters, with remove dups and joinpath optimizations (XPath 3.1)") {
      Given("the sharedXPathWADL")
      When("The WADL is transalted")
      val checker = builder.build(sharedXPathWADL, TestConfig(true, false, true, true, true, 31, true, true, false, "SaxonHE", true))
      Then ("The following paths should hold")
    ...
    scenario ("The sharedXPathWADL is processed checking wellformness, XSD, elemnts, and plain parameters, with remove dups and joinpath optimizations (preserve request body, XPath 2.0)") {
      Given("the sharedXPathWADL")
      When("The WADL is transalted")
      val config = TestConfig(true, false, true, true, true, 20, true, true, false, "Xalan", true)
      config.preserveRequestBody = true
      val checker = builder.build(sharedXPathWADL, config)
    ...
    scenario ("The sharedXPathWADL is processed checking wellformness, XSD, elemnts, and plain parameters, with remove dups and joinpath optimizations (preserve request body, XPath 3.0)") {
      Given("the sharedXPathWADL")
      When("The WADL is transalted")
      val config = TestConfig(true, false, true, true, true, 30, true, true, false, "SaxonHE", true)
      config.preserveRequestBody = true
      val checker = builder.build(sharedXPathWADL, config)
    ...
    scenario ("The sharedXPathWADL is processed checking wellformness, XSD, elemnts, and plain parameters, with remove dups and joinpath optimizations (preserve request body, XPath 3.1)") {
      Given("the sharedXPathWADL")
      When("The WADL is transalted")
      val config = TestConfig(true, false, true, true, true, 31, true, true, false, "SaxonHE", true)
      config.preserveRequestBody = true
      val checker = builder.build(sharedXPathWADL, config)
...
<application xmlns="http://wadl.dev.java.net/2009/02"
    ...
    scenario ("The sharedXPathWADL2 is processed checking wellformness, elemnts, and plain parameters, with remove dups and joinpath optimizations, XPath 2.0") {
      Given("the sharedXPathWADL2")
      When("The WADL is transalted")
      val checker = builder.build(sharedXPathWADL2, TestConfig(true, false, true, true, true, 20, true, true, false, "SaxonHE", true))
      Then ("The following paths should hold")
    ...
    scenario ("The sharedXPathWADL2 is processed checking wellformness, elemnts, and plain parameters, with remove dups and joinpath optimizations, XPath 3.0") {
      Given("the sharedXPathWADL2")
      When("The WADL is transalted")
      val checker = builder.build(sharedXPathWADL2, TestConfig(true, false, true, true, true, 30, true, true, false, "SaxonHE", true))
      Then ("The following paths should hold")
    ...
    scenario ("The sharedXPathWADL2 is processed checking wellformness, elemnts, and plain parameters, with remove dups and joinpath optimizations, XPath 3.1") {
      Given("the sharedXPathWADL2")
      When("The WADL is transalted")
      val checker = builder.build(sharedXPathWADL2, TestConfig(true, false, true, true, true, 31, true, true, false, "SaxonHE", true))
      Then ("The following paths should hold")
    ...
    scenario ("The sharedXPathWADL2 is processed checking wellformness, elemnts, and plain parameters, with remove dups and joinpath optimizations (preserve request body, XPath 2.0)") {
      Given("the sharedXPathWADL2")
      When("The WADL is transalted")
      val config = TestConfig(true, false, true, true, true, 20, true, true, false, "SaxonHE", true)
      config.preserveRequestBody = true
      val checker = builder.build(sharedXPathWADL2, config)
      Then ("The following paths should hold")
    ...
    scenario ("The sharedXPathWADL2 is processed checking wellformness, elemnts, and plain parameters, with remove dups and joinpath optimizations (preserve request body, XPath 3.0)") {
      Given("the sharedXPathWADL2")
      When("The WADL is transalted")
      val config = TestConfig(true, false, true, true, true, 30, true, true, false, "SaxonHE", true)
      config.preserveRequestBody = true
...
<application xmlns="http://wadl.dev.java.net/2009/02"
    ...
    scenario ("The sharedXPathWADL3 is processed checking wellformness, elemnts, and plain parameters, with remove dups optimization (XPath 2.0, Saxon HE)") {
      Given("the sharedXPathWADL3")
      When("The WADL is transalted")

      val config = TestConfig(removeDups = true, saxoneeValidation = false, wellFormed = true,
                              checkXSDGrammar = false, checkElements = true, xpathVersion = 20,
                              checkPlainParams = true, doXSDGrammarTransform = false,
                              enablePreProcessExtension = true, xslEngine = "SaxonHE",
                              joinXPathChecks = false, checkHeaders = false,
                              enableIgnoreXSDExtension = false, enableMessageExtension = false,
                              checkJSONGrammar = false, enableIgnoreJSONSchemaExtension = false,
                              enableRaxRolesExtension = false, preserveRequestBody = false)
    ...
    scenario ("The sharedXPathWADL3 is processed checking wellformness, elemnts, and plain parameters, with remove dups optimization (XPath 3.0, Saxon HE)") {
      Given("the sharedXPathWADL3")
      When("The WADL is transalted")

      val config = TestConfig(removeDups = true, saxoneeValidation = false, wellFormed = true,
                              checkXSDGrammar = false, checkElements = true, xpathVersion = 30,
                              checkPlainParams = true, doXSDGrammarTransform = false,
                              enablePreProcessExtension = true, xslEngine = "SaxonHE",
                              joinXPathChecks = false, checkHeaders = false,
                              enableIgnoreXSDExtension = false, enableMessageExtension = false,
    ...
    scenario ("The sharedXPathWADL3 is processed checking wellformness, elemnts, and plain parameters, with remove dups optimization (XPath 3.1, Saxon HE)") {
      Given("the sharedXPathWADL3")
      When("The WADL is transalted")
    ...
    scenario ("The sharedXPathWADL3 is processed checking wellformness, elemnts, and plain parameters, with remove dups and joinpath optimizations (XPath 2.0, SaxonHE)") {
      Given("the sharedXPathWADL3")
      When("The WADL is transalted")
      val config = TestConfig(removeDups = true, saxoneeValidation = false, wellFormed = true,
                              checkXSDGrammar = false, checkElements = true, xpathVersion = 20,
    ...
    scenario ("The sharedXPathWADL3 is processed checking wellformness, elemnts, and plain parameters, with remove dups and joinpath optimizations (XPath 3.0, SaxonHE)") {
      Given("the sharedXPathWADL3")
      When("The WADL is transalted")
      val config = TestConfig(removeDups = true, saxoneeValidation = false, wellFormed = true,
                              checkXSDGrammar = false, checkElements = true, xpathVersion = 30,
    ...
    scenario ("The sharedXPathWADL3 is processed checking wellformness, elemnts, and plain parameters, with remove dups and joinpath optimizations (XPath 3.1, SaxonHE)") {
      ...
      When("The WADL is transalted")
      val config = TestConfig(removeDups = true, saxoneeValidation = false, wellFormed = true,
                              checkXSDGrammar = false, checkElements = true, xpathVersion = 31,
                              checkPlainParams = true, doXSDGrammarTransform = false,
                              enablePreProcessExtension = true, xslEngine = "SaxonHE",
                              joinXPathChecks = true, checkHeaders = false,
                              enableIgnoreXSDExtension = false, enableMessageExtension = false,
    ...
    scenario ("The sharedXPathWADL3 is processed checking wellformness, elemnts, and plain parameters, with remove dups and joinpath optimizations (preserve request body, SaxonHE, XPath 2.0)") {
      Given("the sharedXPathWADL3")
      When("The WADL is transalted")
      val config = TestConfig(removeDups = true, saxoneeValidation = false, wellFormed = true,
                              checkXSDGrammar = false, checkElements = true, xpathVersion = 20,
    ...
    scenario ("The sharedXPathWADL3 is processed checking wellformness, elemnts, and plain parameters, with remove dups and joinpath optimizations (preserve request body, SaxonHE, XPath 3.0)") {
      Given("the sharedXPathWADL3")
      When("The WADL is transalted")
      val config = TestConfig(removeDups = true, saxoneeValidation = false, wellFormed = true,
                              checkXSDGrammar = false, checkElements = true, xpathVersion = 30,
