...
class WADLCheckerOptSpecSaxonEE extends BaseCheckerSpec {
  //
  ...
  feature ("The WADLCheckerBuilder can correctly transforma a WADL into checker format") {
    ...
    scenario ("The sharedXPathWADL is processed checking wellformness, XSD, elemnts, and plain parameters, with remove dups and joinpath optimizations (XPath 3.0, SaxonEE)") {
      Given("the sharedXPathWADL")
      When("The WADL is transalted")
      val checker = builder.build(sharedXPathWADL, TestConfig(true, false, true, true, true, 30, true, true, false, "SaxonEE", true))
    ...
    scenario ("The sharedXPathWADL is processed checking wellformness, XSD, elemnts, and plain parameters, with remove dups and joinpath optimizations (XPath 3.1, SaxonEE)") {
      Given("the sharedXPathWADL")
      When("The WADL is transalted")
      val checker = builder.build(sharedXPathWADL, TestConfig(true, false, true, true, true, 31, true, true, false, "SaxonEE", true))
      Then ("The following paths should hold")
    ...
    scenario ("The sharedXPathWADL is processed checking wellformness, XSD, elemnts, and plain parameters, with remove dups and joinpath optimizations (preserve request body, XPath 3.0, SaxonEE)") {
      Given("the sharedXPathWADL")
      When("The WADL is transalted")
      val config = TestConfig(true, false, true, true, true, 30, true, true, false, "SaxonEE", true)
    ...
    scenario ("The sharedXPathWADL is processed checking wellformness, XSD, elemnts, and plain parameters, with remove dups and joinpath optimizations (preserve request body, XPath 3.1, SaxonEE)") {
      Given("the sharedXPathWADL")
      When("The WADL is transalted")
      val config = TestConfig(true, false, true, true, true, 31, true, true, false, "SaxonEE", true)
      config.preserveRequestBody = true
      val checker = builder.build(sharedXPathWADL, config)
...
<application xmlns="http://wadl.dev.java.net/2009/02"
    ...
    scenario ("The sharedXPathWADL2 is processed checking wellformness, elemnts, and plain parameters, with remove dups and joinpath optimizations, XPath 3.0, SaxonEE") {
      Given("the sharedXPathWADL2")
      When("The WADL is transalted")
      val checker = builder.build(sharedXPathWADL2, TestConfig(true, false, true, true, true, 30, true, true, false, "SaxonEE", true))
      Then ("The following paths should hold")
    ...
    scenario ("The sharedXPathWADL2 is processed checking wellformness, elemnts, and plain parameters, with remove dups and joinpath optimizations, XPath 3.1, SaxonEE") {
      Given("the sharedXPathWADL2")
      When("The WADL is transalted")
      val checker = builder.build(sharedXPathWADL2, TestConfig(true, false, true, true, true, 31, true, true, false, "SaxonEE", true))
      Then ("The following paths should hold")
    ...
    scenario ("The sharedXPathWADL2 is processed checking wellformness, elemnts, and plain parameters, with remove dups and joinpath optimizations (preserve request body, XPath 3.0, SaxonEE)") {
      Given("the sharedXPathWADL2")
      When("The WADL is transalted")
      val config = TestConfig(true, false, true, true, true, 30, true, true, false, "SaxonEE", true)
      config.preserveRequestBody = true
    ...
    scenario ("The sharedXPathWADL2 is processed checking wellformness, elemnts, and plain parameters, with remove dups and joinpath optimizations (preserve request body, XPath 3.1, SaxonEE)") {
      Given("the sharedXPathWADL2")
      When("The WADL is transalted")
      val config = TestConfig(true, false, true, true, true, 31, true, true, false, "SaxonEE", true)
      config.preserveRequestBody = true
...
<application xmlns="http://wadl.dev.java.net/2009/02"
    ...
    scenario ("The sharedXPathWADL3 is processed checking wellformness, elemnts, and plain parameters, with remove dups optimization (XPath 3.0, Saxon EE)") {
      ...
      val config = TestConfig(removeDups = true, saxoneeValidation = false, wellFormed = true,
                              ...
                              enablePreProcessExtension = true, xslEngine = "SaxonEE",
    ...
    scenario ("The sharedXPathWADL3 is processed checking wellformness, elemnts, and plain parameters, with remove dups optimization (XPath 3.1, Saxon EE)") {
      Given("the sharedXPathWADL3")
      When("The WADL is transalted")
    ...
    scenario ("The sharedXPathWADL3 is processed checking wellformness, elemnts, and plain parameters, with remove dups and joinpath optimizations (XPath 3.0, SaxonEE)") {
      Given("the sharedXPathWADL3")
      When("The WADL is transalted")
      val config = TestConfig(removeDups = true, saxoneeValidation = false, wellFormed = true,
                              checkXSDGrammar = false, checkElements = true, xpathVersion = 30,
    ...
    scenario ("The sharedXPathWADL3 is processed checking wellformness, elemnts, and plain parameters, with remove dups and joinpath optimizations (XPath 3.1, SaxonEE)") {
      Given("the sharedXPathWADL3")
      When("The WADL is transalted")
      val config = TestConfig(removeDups = true, saxoneeValidation = false, wellFormed = true,
                              checkXSDGrammar = false, checkElements = true, xpathVersion = 31,
    ...
    scenario ("The sharedXPathWADL3 is processed checking wellformness, elemnts, and plain parameters, with remove dups and joinpath optimizations (preserve request body, SaxonEE, XPath 3.0)") {
      Given("the sharedXPathWADL3")
      When("The WADL is transalted")
      val config = TestConfig(removeDups = true, saxoneeValidation = false, wellFormed = true,
                              checkXSDGrammar = false, checkElements = true, xpathVersion = 30,
    ...
    scenario ("The sharedXPathWADL3 is processed checking wellformness, elemnts, and plain parameters, with remove dups and joinpath optimizations (preserve request body, SaxonEE, XPath 3.1)") {
      Given("the sharedXPathWADL3")
      When("The WADL is transalted")
      val config = TestConfig(removeDups = true, saxoneeValidation = false, wellFormed = true,
                              checkXSDGrammar = false, checkElements = true, xpathVersion = 31,
