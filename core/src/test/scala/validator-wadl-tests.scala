...
class ValidatorWADLSuite extends BaseValidatorSuite {
  ...
  val atomValidator = Validator((localWADLURI,
    <application xmlns="http://wadl.dev.java.net/2009/02"
                 xmlns:xs="http://www.w3.org/2001/XMLSchema"
                 xmlns:atom="http://www.w3.org/2005/Atom">
      <grammars>
        <include href="src/test/resources/xsd/entry.xsd"/>
      </grammars>
      <resources base="http://localhost/">
        ...
        <resource path="accountstatus/events" type="src/test/resources/wadl/feed.wadl#AtomFeed src/test/resources/wadl/feed.wadl#Unvalidated"/>
        <resource path="cbs/events" type="src/test/resources/wadl/feed.wadl#AtomFeed src/test/resources/wadl/product.wadl#CloudBlockStorage"/>
        <resource path="dns/events" type="src/test/resources/wadl/feed.wadl#AtomFeed src/test/resources/wadl/feed.wadl#Unvalidated"/>
        <resource path="files/events" type="src/test/resources/wadl/feed.wadl#AtomFeed src/test/resources/wadl/product.wadl#CloudFiles"/>
        <resource path="sites/events" type="src/test/resources/wadl/feed.wadl#AtomFeed src/test/resources/wadl/product.wadl#CloudSites"/>
        <resource path="domain/events" type="src/test/resources/wadl/feed.wadl#AtomFeed src/test/resources/wadl/product.wadl#DomainRegistration"/>
        <resource path="dbaas/events" type="src/test/resources/wadl/feed.wadl#AtomFeed src/test/resources/wadl/product.wadl#CloudDatabase"/>
        <resource path="glance/events" type="src/test/resources/wadl/feed.wadl#AtomFeed src/test/resources/wadl/product.wadl#Glance"/>
        <resource path="lbaas/events" type="src/test/resources/wadl/feed.wadl#AtomFeed src/test/resources/wadl/product.wadl#CloudLoadBalancers"/>
        <resource path="servers/events" type="src/test/resources/wadl/feed.wadl#AtomFeed src/test/resources/wadl/product.wadl#CloudServers src/test/resources/wadl/product.wadl#RHEL"/>
        <resource path="melange/events" type="src/test/resources/wadl/feed.wadl#AtomFeed src/test/resources/wadl/feed.wadl#Unvalidated"/>
        <resource path="monitoring/events" type="src/test/resources/wadl/feed.wadl#AtomFeed src/test/resources/wadl/product.wadl#CloudMonitoring"/>
        <resource path="nova/events" type="src/test/resources/wadl/feed.wadl#AtomFeed src/test/resources/wadl/product.wadl#CloudServersOpenStack src/test/resources/wadl/product.wadl#RHEL"/>
        <resource path="quantum/events" type="src/test/resources/wadl/feed.wadl#AtomFeed src/test/resources/wadl/feed.wadl#Unvalidated"/>
        <resource path="demo/events" type="src/test/resources/wadl/feed.wadl#AtomFeed src/test/resources/wadl/feed.wadl#Unvalidated"/>
        <resource path="usagetest1/events" type="src/test/resources/wadl/feed.wadl#AtomFeed src/test/resources/wadl/feed.wadl#Validated"/>
        <resource path="usagetest2/events" type="src/test/resources/wadl/feed.wadl#AtomFeed src/test/resources/wadl/feed.wadl#Validated"/>
        <resource path="usagetest3/events" type="src/test/resources/wadl/feed.wadl#AtomFeed src/test/resources/wadl/feed.wadl#Validated"/>
        <resource path="usagetest4/events" type="src/test/resources/wadl/feed.wadl#AtomFeed src/test/resources/wadl/feed.wadl#Validated"/>
        <resource path="usagetest5/events" type="src/test/resources/wadl/feed.wadl#AtomFeed src/test/resources/wadl/feed.wadl#Validated"/>
        <resource path="usagetest6/events" type="src/test/resources/wadl/feed.wadl#AtomFeed src/test/resources/wadl/feed.wadl#Validated"/>
        <resource path="usagetest7/events" type="src/test/resources/wadl/feed.wadl#AtomFeed src/test/resources/wadl/feed.wadl#Unvalidated"/>
        <resource path="usagetest8/events" type="src/test/resources/wadl/feed.wadl#AtomFeed src/test/resources/wadl/feed.wadl#Unvalidated"/>
        <resource path="identity/users/deleted" type="src/test/resources/wadl/feed.wadl#AtomFeed src/test/resources/wadl/product.wadl#CloudIdentity"/>
        <resource path="identity/users/disabled" type="src/test/resources/wadl/feed.wadl#AtomFeed src/test/resources/wadl/product.wadl#CloudIdentity"/>
        <resource path="identity/users/migrated/CloudAuth" type="src/test/resources/wadl/feed.wadl#AtomFeed src/test/resources/wadl/product.wadl#CloudIdentity"/>
        <resource path="identity/users/migrated/CloudSitesLDAP" type="src/test/resources/wadl/feed.wadl#AtomFeed src/test/resources/wadl/product.wadl#CloudIdentity"/>
        <resource path="identity/users/revoked" type="src/test/resources/wadl/feed.wadl#AtomFeed src/test/resources/wadl/product.wadl#CloudIdentity"/>
        <resource path="identity/roles/updated" type="src/test/resources/wadl/feed.wadl#AtomFeed src/test/resources/wadl/product.wadl#CloudIdentity"/>
        <resource path="identity/groups/updated" type="src/test/resources/wadl/feed.wadl#AtomFeed src/test/resources/wadl/product.wadl#CloudIdentity"/>
        <resource path="nimbus/events" type="src/test/resources/wadl/feed.wadl#AtomFeed src/test/resources/wadl/feed.wadl#Unvalidated"/>
        <resource path="backup/events" type="src/test/resources/wadl/feed.wadl#AtomFeed src/test/resources/wadl/product.wadl#CloudBackup"/>
        <resource path="meta/events" type="src/test/resources/wadl/feed.wadl#AtomFeed src/test/resources/wadl/product.wadl#AtomHopper"/>
      </resources>
    </application>)
    , TestConfig(false, false, true, true, false, 1, false, true, true, "Saxon"))
