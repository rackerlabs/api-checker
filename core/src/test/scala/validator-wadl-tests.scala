...
class ValidatorWADLSuite extends BaseValidatorSuite {
  ...
  test ("GET on /path/to/my/resource/bbe10c88-6477-11e1-84cf-979e24b1498f should succeed on validator_UUID_inline") {
    validator_UUID_inline.validate(request("GET","/path/to/my/resource/bbe10c88-6477-11e1-84cf-979e24b1498f"),response)
  }

  test ("GET on /path/to/my/resource/e5b13268-6477-11e1-8e8a-ff0ea421704f should succeed on validator_UUID_inline") {
    validator_UUID_inline.validate(request("GET","/path/to/my/resource/e5b13268-6477-11e1-8e8a-ff0ea421704f"),response)
  }

  test ("GET on /path/to/my/resource/16dfce76-6478-11e1-9e38-97e6e1882c28 should succeed on validator_UUID_inline") {
    validator_UUID_inline.validate(request("GET","/path/to/my/resource/16dfce76-6478-11e1-9e38-97e6e1882c28"),response)
  }

  test ("DELETE on /path/to/my/resource/bbe10c88-6477-11e1-84cf-979e24b1498f should fail on validator_UUID_inline") {
    assertResultFailed(validator_UUID_inline.validate(request("DELETE","/path/to/my/resource/bbe10c88-6477-11e1-84cf-979e24b1498f"),response), 405)
  }

  test ("GET on /path/to/my/resource/bbe10c88-6477-11e1-84cf-979e24b1498z should fail on validator_UUID_inline") {
    assertResultFailed(validator_UUID_inline.validate(request("GET","/path/to/my/resource/bbe10c88-6477-11e1-84cf-979e24b1498z"),response), 404)
  }

  test ("GET on /path/to/100 should succeed on validator_UUID_inline") {
    validator_UUID_inline.validate(request("GET","/path/to/100"),response)
  }

  test ("GET on /path/to/20 should succeed on validator_UUID_inline") {
    validator_UUID_inline.validate(request("GET","/path/to/20"),response)
  }

  test ("GET on /path/to/hello should fail on validator_UUID_inline") {
    assertResultFailed(validator_UUID_inline.validate(request("GET","/path/to/hello"),response), 404)
  }

  test ("GET on /path/to/101 should fail on validator_UUID_inline") {
    assertResultFailed(validator_UUID_inline.validate(request("GET","/path/to/101"),response), 404)
  }
}
