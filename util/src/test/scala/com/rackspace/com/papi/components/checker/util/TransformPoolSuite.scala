...
class TransformPoolSuite extends FunSuite {
  ...
  val templates1 = factory.newTemplates (new StreamSource(getClass.getResource("/xsl/test1.xsl").toString))
  val templates2 = factory.newTemplates (new StreamSource(getClass.getResource("/xsl/test2.xsl").toString))
