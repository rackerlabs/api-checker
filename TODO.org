...
** TODO Check Headers [2/8]
   1. [X] Added option to config
   2. [X] Extends XSD
   3. [-] Add support in XSL [1/2]
      1. [ ] Headers on request
      2. [X] Headers on resource
   4. [ ] Handle config in CLI tools
   5. [ ] Add support in opt XSLs
   6. [ ] Add Header Steps
   7. [ ] Update handler for new steps
   8. [ ] Tests
      1. [ ] Handler tests
      ...
      4. [ ] XSD Test
      5. [ ] Default Header
** TODO Header Enhancements [0/2]
   1. [ ] Add default / fixed headers
   2. [ ] Hadle headers on response
