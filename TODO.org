...
** TODO Add support for rax:copyToHeader extension [4/11]
   ...
   5. [ ] New config option copyToHeader
   6. [ ] Add copyToHeader option to CLI utils
   7. [ ] Add concept of copyToHeader to checker XSD
   8. [ ] Change builder.xsl to support copyToHeader extension
   9. [ ] Update optimizations to support copyToHeader extension
   10. [ ] Add support to copyToHeader in step builder
   11. [-] Tests [2/5]
       1. [X] HeaderMap tests
       2. [X] State Tests [8/8]
          1. [X] URI
       ...
       3. [ ] Checker Tests [0/5]
          ...
          5. [ ] XPath
       4. [ ] WADL Tests
          1. [ ] rax:copyToHeader on template
          2. [ ] rax:copyToHeader on header
          3. [ ] rax:copyToHeader on plan
       5. [ ] Performance test
