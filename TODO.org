...
** DONE Preprocess Step [12/12]
   ...
   12. [X] Tests[4/4]
       ...
       4. [X] WADL Validator [2/2]
          ...
          2. [X] XSLT 2.0 (Saxon)
** TODO Inline XSL should be supported in XSL step [1/4]
   1. [X] Confirm that XSL servies WADL tools translation / fix if not.
   2. [ ] Modify builder to copy emebed xsl
   3. [ ] Modify step handler to compile templates
   4. [ ] Tests [0/4]
      1. [ ] Add builder XSL test
      2. [ ] Add step handler test
      3. [ ] Add validator tests: embeded namespaces
      4. [ ] Add validator tests: parent namespaces
