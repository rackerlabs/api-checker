      ...
      2. [X] Make sure content is communicated upstream [3/3]
         ...
         3. [X] WADL Validator Tests [2/2]
            ...
            2. [X] Validate with transforms and options on XML (Xerces /
                   Saxon), new tests.
** TODO Preprocess Step [0/10]
   1. [ ] Add support for XSL step in XSD
   2. [ ] Add support for preprocess in config
   3. [ ] Add support for XSL 1.0 engine
   4. [ ] Add support for preprocess in XSLs
   5. [ ] Update CLI tools
   6. [ ] Add Transform Pool
   7. [ ] Create Transform State
   8. [ ] Add support for preprocess in Transform state
   9. [ ] Tests[0/5]
      1. [ ] Transform pool
      2. [ ] States
         1. [ ] XSL 1.0 (Xerces)
         ...
         3. [ ] XSL 2.0
      3. [ ] Checker Tests
         1. [ ] Tests with XSL Stages
         2. [ ] Tests without XSL stanges
         3. [ ] Preprocess without well formed specified
         4. [ ] Dups vs noDups
      4. [ ] Step Builder Tests
      5. [ ] WADL Validator
         1. [ ] XSLT 1.0 (Xalan)
         2. [ ] XSLT 1.0 (Xalan-C)
         3. [ ] XSLT 2.0 (Saxon)
   10. [ ] Update filter / filter app
