...
** TODO Extend machine to handle correct element in XML [8/11]
   ...
   9. [-] Tests[4/7]
      ...
      5. [ ] Step Builder Tests
         1. [ ] Confirm XPath 2.0 Setting
      6. [ ] WADL Validator
         1. [ ] XPath 1.0
         2. [ ] XPath 2.0
   10. [ ] Better errors when multiple XPath expressions fail.
       1. [ ] Test, to prove that that's working.
   11. [ ] Update filter / filter app
** TODO Extend machine to check required plain parameters
   1. [ ] Tests
         1. [ ] Tests with dups in XPath (with/without version)
         2. [ ] Test Bad XPaths
