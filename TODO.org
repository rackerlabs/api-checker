...
** DONE rax:code for XPath message [7/7]
   ...
   7. [X] TESTS [4/4]
      ...
      4. [X] Test XPath Join on [3/3]
         ...
         2. [X] Xalan 1.0
         3. [X] XalanC 1.0
** TODO Add support for JSONSchema in body [0/8]
   1. [ ] Add support for JSON_SCHEMA_CHECK in XSD
   2. [ ] Add JSON_SCHEMA_CHECK in configs
   3. [ ] Add support for check in XSLs, include support for rax:ignore-jsonschema
   4. [ ] Update CLI tools if nessesary
   5. [ ] Create validator pool if nessesary
