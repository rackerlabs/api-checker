...
** TODO XPath join optimization [8/9]
   ...
   9. [-] Test [1/4]
      ...
      2. [ ] Checker tests with mix of xpath1 and xpath2
      3. [ ] Ensure that validator XPath tests work with validator
      4. [ ] Enable Optimization in validator tests Well, XSD, XSLT in mix
