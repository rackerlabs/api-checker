...
** TODO Header Enhancements [2/4]
   ...
   3. [ ] Add support for rax:code and rax:message in Header checks[0/5]
      1. [ ] Extend XSD to allow passing code, message to Header States
      2. [ ] Extend builder XSL to add code, message
      3. [ ] Modify Header states to accept code, message
      4. [ ] Make sure join optimizations are aware of the extension
      5. [ ] TESTS [0/3]
         1. [ ] State
         2. [ ] Builder
         3. [ ] Validator
