...
** TODO Extend machine to check required plain parameters[0/4]
   1. [ ] Add required plain param in config
   2. [ ] Add support for check in XSLs
   3. [ ] Update CLI tools
   4. [ ] Tests[0/2]
      1. [ ] Checker Tests[0/2]
         1. [ ] Dups vs NoDups
         2. [ ] With / Without XSD checks
      2. [ ] WADL Validator tests
         1. [ ] XPath 1.0
         2. [ ] XPath 2.0
         3. [ ] XPath 2.0 complex (assertions, etc)
** TODO XPath check enhancements[0/5]
   1. [ ] Better errors when multiple XPath expressions fail --
      display.
   2. [ ] WADL extension to support XPath 2.0 (xpathversion=2.0)
   3. [ ] Clark notation for error messages.
   4. [ ] Combine XPath optimization
   5. [ ] Tests
