...
** TODO XPath join optimization [1/9]
   ...
   4. [ ] Add new config option
   5. [ ] Add new optional stage to builder
   6. [ ] Update CLI tools
   7. [ ] Update Filter / Filter Test App
   8. [ ] Extend XSL stage to handle error messages
   9. [ ] Test [0/2]
