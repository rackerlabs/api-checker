...
** TODO XSD Transform [0/6]
   1. [ ] Add XSD transform option to config
   2. [ ] Add support for XSD transform in XSD
   3. [ ] Add support for XSD transform in XSD step
   4. [ ] Add support for XSD transform in Handler
   5. [ ] Add support for communicationg content upstream [0/3]
      1. [ ] XML
      2. [ ] JSON
      3. [ ] Other / None
   6. [ ] Tests [0/2]
      1. [ ] Ensure that checker moves option
      2. [ ] Make sure content is communicated upstream [0/4]
         1. [ ] Validate with options on XML
         2. [ ] Validate with options off XML
         3. [ ] Well-Form XML
         4. [ ] Well-Form JSON
