...
** TODO Extend machine to handle correct element in XML [7/9]
   ...
   8. [ ] New Config XPath version [0/2]
      1. [ ] 1.0 based on Xalan (default)
      2. [ ] 2.0 based on Saxon (non-schema aware -- unless you have license)
   9. [-] Tests[1/7]
      1. [X] XPath parser pool
      2. [ ] Tests on XPath 1.0 and 2.0
      3. [ ] ImmutableNamespaceContext
      4. [ ] States
      5. [ ] Checker Tests
         1. [ ] Should check case no element is specified.
         2. [ ] Tests with XSD stages.
         3. [ ] Tests without XSD stages.
      6. [ ] Step Builder Tests
      7. [ ] WADL Validator
