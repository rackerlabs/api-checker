...
** DONE rax:message XPath extension [8/8]
   ...
   8. [X] TESTS [3/3]
      ...
      2. [X] Builder
      3. [X] Validator
** TODO rax:code for XPath message [0/6]
   1. [ ] Allow passing code to content error state (Defualt 400)
   2. [ ] Extend XSD to allow code in XPath
   3. [ ] Extend builder XSL to add code in XPath state
   4. [ ] Extend handler to pass code over
   5. [ ] Make join optimization aware of the extension
   6. [ ] TESTS [0/3]
      1. [ ] State
      2. [ ] Builder
      3. [ ] Validator
** TODO Header Enhancements [1/3]
   ...
   2. [-] Handle fixed headers [5/6]
      ...
      6. [ ] Join fixed headers opt?
   3. [ ] Handle default headers
