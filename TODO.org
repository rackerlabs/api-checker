...
** TODO Implement validator [6/9]
   ...
   7. [ ] Capture attempt in error steps
   8. [ ] Quickly extract correct error in multi-result case
   9. [ ] Assert that validator tests above return the correct error
