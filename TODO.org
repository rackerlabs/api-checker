...
** TODO rax:message XPath extension [0/5]
   1. [ ] Extend XSD to allow message in XPath
   2. [ ] Extend builder XSL to add message in XPath state
   3. [ ] Extend state to accept message in XPath
   4. [ ] Extend handler to pass message over
   5. [ ] TESTS [0/3]
      1. [ ] State
      2. [ ] Builder
      3. [ ] Validator
