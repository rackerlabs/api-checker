...
** TODO XSD Transform [4/9]
   ...
   5. [ ] Handle config change correctly in XSD
   6. [ ] Handle set and not set in dups options
   7. [ ] Add support for communicationg content upstream [0/3]
      1. [ ] XML
      2. [ ] JSON
      3. [ ] Other / None
   8. [ ] Update filter-app
   9. [ ] Tests [0/2]
      ...
      2. [ ] Make sure content is communicated upstream [0/4]
         1. [ ] Validate with options on XML (Xerces / Saxon)
         3. [ ] Validate with options off XML (Xerces / Saxon)
         4. [ ] Well-Form XML (Xerces / Saxon)
         5. [ ] Well-Form JSON
